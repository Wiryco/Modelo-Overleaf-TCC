...
\centering % para centralizarmos a figura
\includegraphics[width=10cm]{revisao-bibliografica/Figuras/Computer-Vision-Pixel.jpg}% leia abaixo
\label{figura:figura3}

\centering \subfloat {\footnotesize { Disponível em: https://zbigatron.com/why-is-image-processing-so-hard/ }}
{
\label{figura:figura3}
}
\end{figure}
